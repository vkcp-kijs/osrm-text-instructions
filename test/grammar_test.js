...
const grammarTests = {
    ...
    'lv': [
        ...
        ['Satekles iela (A6, A7, A8, A10)', 'accusative', 'Satekles ielu (A6, A7, A8, A10)'],
        ['Satekles iela (A6, A7, A8, A10)', 'dative', 'Satekles ielai (A6, A7, A8, A10)'],
        ['Satekles iela (A6, A7, A8, A10)', 'genitive', 'Satekles ielas (A6, A7, A8, A10)'],
        ['Merķeļa iela (A2, P1)', 'accusative', 'Merķeļa ielu (A2, P1)'],
        ['Merķeļa iela (A2, P1)', 'dative', 'Merķeļa ielai (A2, P1)'],
        ['Merķeļa iela (A2, P1)', 'genitive', 'Merķeļa ielas (A2, P1)'],
        ['pirmais', 'accusative', 'pirmo'],
        ['pirmais', 'locative', 'pirmajā'],
        ['otrais', 'accusative', 'otro'],
        ['otrais', 'locative', 'otrajā'],
        ['trešais', 'accusative', 'trešo'],
        ['trešais', 'locative', 'trešajā'],
        ['ceturtais', 'accusative', 'ceturto'],
        ['ceturtais', 'locative', 'ceturtajā'],
        ['piektais', 'accusative', 'piekto'],
        ['piektais', 'locative', 'piektajā'],
        ['sestais', 'accusative', 'sesto'],
        ['sestais', 'locative', 'sestajā'],
        ['septītais', 'accusative', 'septīto'],
        ['septītais', 'locative', 'septītajā'],
        ['astotais', 'accusative', 'astoto'],
        ['astotais', 'locative', 'astotajā'],
        ['devītais', 'accusative', 'devīto'],
        ['devītais', 'locative', 'devītajā'],
        ['desmitais', 'accusative', 'desmito'],
        ['desmitais', 'locative', 'desmitajā']
    ],
    'ru': [
